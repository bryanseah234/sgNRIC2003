...
At first I wanted to find out the population size born each year, but realised the government is publicising that information. So I moved on to proving how easily it is to generate someone else's NRIC, using Python.
